...
class DefaultBidGenerator(object):
    ...
    def _GenerateAdSlot(self, bid_request):
        ...
        ad_slot.publisher_settings_list_id.append(bid_request.publisher_settings_list_id
                                                  + ad_slot.id)
        ...
        for generated_id in generated_ids:
            ...
            ad_data.billing_id.append(generated_id)
...
class MobileBidGenerator(DefaultBidGenerator):
    ...
    def GenerateBidRequest(self):
        ...
        device.carrier_id = random.choice(MOBILE_CARRIERS)
        device.platform = platform
        device.os_version.major = os_major_version
        device.os_version.minor = os_minor_version
        device.os_version.micro = os_micro_version
        device.device_type = device_type
        device.screen_orientation = orientation
